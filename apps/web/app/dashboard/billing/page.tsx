...
import { Loader2, AlertCircle, CheckCircle2, CreditCard, Coins, History, ArrowUpRight } from 'lucide-react'
...
export default function BillingPage() {
    ...
    const usage = useQuery(api.lib.credits.getUsageHistory, walletAddress ? { walletAddress } : 'skip')
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">
                                    {pricing?.tierConfig.rateLimit}/min
                                </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground">Extra credits when paying with GHOST</p>
                            </CardContent>
                        </Card>
                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    {tokenPrices && (
                                        <p className="text-xs text-muted-foreground">
                                            Current Price: ${selectedToken === 'USDC' ? 1 : selectedToken === 'SOL' ? tokenPrices.sol.toFixed(2) : tokenPrices.ghost.toFixed(6)}
                                        </p>
                                    )}
                                </div>
                            ...
                            <CardContent>
                                <Tabs defaultValue="usage">
                                    <TabsList className="w-full">
                                        <TabsTrigger value="usage" className="flex-1">API Usage</TabsTrigger>
                                                    ...
                                                    <TableBody>
                                                        {usage?.recentCalls.map((call, i) => (
                                                            <TableRow key={i}>
                                                                ...
                                                                <TableCell className="text-right text-destructive">-{call.credits}</TableCell>
                                                            </TableRow>
                                                        ))}
                                                    </TableBody>
                                                </Table>
