  ...
  const steps = [
    {
      ...
      details: ['Generate Ed25519 keypair', 'Create DID identifier', 'Sign initial transaction'],
    },
    {
      icon: Database,
      number: '02',
    ...
    },
    {
      ...
      details: ['Track transaction history', 'Collect endorsements', 'Calculate reputation score'],
    },
    {
      icon: Globe,
      number: '04',
      ...
      details: ['Generate W3C credentials', 'Store on IPFS', 'Bridge to EVM chains'],
    },
  ]
