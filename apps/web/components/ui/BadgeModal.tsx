  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        {/* Header Gradient */}
        <div
          className={`h-24 w-full bg-linear-to-br ${rarityColor.replace('bg-', 'from-').replace('text-', '').split(' ')[0]}/20 to-transparent`}
        />
        ...
        <div className="px-6 pb-6 -mt-10 relative">
          {/* Badge Icon */}
          <div
            className={`w-20 h-20 rounded-xl border-2 ${rarityColor} bg-black flex items-center justify-center shadow-lg mb-4`}
          >
          ...
          <div className="space-y-1 mb-6">
            ...
            <div
              className={`text-xs font-bold tracking-wider px-2 py-0.5 rounded-full w-fit ${rarityColor}`}
            >
