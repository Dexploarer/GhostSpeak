...
<CardGroup cols={2}>
  <Card title="Success Rate (40%)" icon="circle-check">
    Payment completion, service delivery, no disputes
  </Card>
  <Card title="Service Quality (30%)" icon="star">
    Client ratings, positive reviews, quality scores
  </Card>
  <Card title="Response Time (20%)" icon="clock">
    Timeliness, availability, consistency
  </Card>
  <Card title="Volume Consistency (10%)" icon="chart-line">
...
<Tabs>
  ...
  <Tab title="Bad Rating">
    ...
    **After**: One 2.0 star rating received
    ...
    New average = ((4.8 × 100) + 2.0) / 101 = 4.77 stars

    **Impact**: -0.03 / 5.0 × 0.30 × 1000 = -1.8 points
  </Tab>
  <Tab title="Slow Response">
    **Before**: 30 min average response
    **After**: One 6-hour response

    New average = ((1800 × 100) + 21600) / 101 = 1980s
