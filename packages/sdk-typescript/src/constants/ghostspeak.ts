 ...
 */
export const GHOSTSPEAK_PROGRAM_ID = address('3yCZtq3dK1WDoz88kryyK7Cv6d9fpNdsbQHFbxcLe9ot')
...
export const NETWORK_CONFIG = {
  ...
  mainnet: {
    programId: '3yCZtq3dK1WDoz88kryyK7Cv6d9fpNdsbQHFbxcLe9ot', // Will be updated for mainnet
