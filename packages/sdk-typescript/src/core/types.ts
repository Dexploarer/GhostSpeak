 ...
 * 
 * All types are organized under the GhostSpeak namespace for better
 ...
 */
export function isSuccess<T>(result: GhostSpeak.Result<T>): result is GhostSpeak.Result<T> & { success: true } {
 ...
 */
export function isError<T>(result: GhostSpeak.Result<T>): result is GhostSpeak.Result<T> & { success: false } {
 ...
 */
export function unwrap<T>(result: GhostSpeak.Result<T>): T {
  if (isError(result)) {
