...
/** Gets the encoder for {@link ReplicationTemplateArgs} account data. */
export function getReplicationTemplateEncoder(): Encoder<ReplicationTemplateArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: REPLICATION_TEMPLATE_DISCRIMINATOR,
    }),
  );
}

/** Gets the decoder for {@link ReplicationTemplate} account data. */
...
/** Gets the codec for {@link ReplicationTemplate} account data. */
