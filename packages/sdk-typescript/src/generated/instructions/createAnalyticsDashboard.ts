...
>(
...
): Promise<CreateAnalyticsDashboardInstruction<TProgramAddress, any[]>> {
  // Program address.
  ...
  } as CreateAnalyticsDashboardInstruction<TProgramAddress, any[]>;
...
>(
  ...
  >,
  config?: { programAddress?: TProgramAddress }
): CreateAnalyticsDashboardInstruction<TProgramAddress, any[]> {
  // Program address.
  const programAddress =
    config?.programAddress ?? GHOSTSPEAK_MARKETPLACE_PROGRAM_ADDRESS;
