...
>(
...
): Promise<CreateMarketAnalyticsInstruction<TProgramAddress, any[]>> {
  // Program address.
  ...
  } as CreateMarketAnalyticsInstruction<TProgramAddress, any[]>;
...
>(
  ...
  >,
  config?: { programAddress?: TProgramAddress }
): CreateMarketAnalyticsInstruction<TProgramAddress, any[]> {
  // Program address.
  const programAddress =
    config?.programAddress ?? GHOSTSPEAK_MARKETPLACE_PROGRAM_ADDRESS;
