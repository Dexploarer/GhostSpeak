...
>(
...
): Promise<InitializeRbacConfigInstruction<TProgramAddress, any[]>> {
  // Program address.
  ...
  } as InitializeRbacConfigInstruction<TProgramAddress, any[]>;
...
>(
  ...
  >,
  config?: { programAddress?: TProgramAddress }
): InitializeRbacConfigInstruction<TProgramAddress, any[]> {
  // Program address.
  const programAddress =
    config?.programAddress ?? GHOSTSPEAK_MARKETPLACE_PROGRAM_ADDRESS;
