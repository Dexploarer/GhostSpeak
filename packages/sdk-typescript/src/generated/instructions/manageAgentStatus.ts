...
>(
...
): Promise<ManageAgentStatusInstruction<TProgramAddress, any[]>> {
  // Program address.
  ...
  } as ManageAgentStatusInstruction<TProgramAddress, any[]>;
...
>(
  ...
  config?: { programAddress?: TProgramAddress }
): ManageAgentStatusInstruction<TProgramAddress, any[]> {
  // Program address.
  const programAddress =
    config?.programAddress ?? GHOSTSPEAK_MARKETPLACE_PROGRAM_ADDRESS;
