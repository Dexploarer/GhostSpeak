...
>(
...
): Promise<UpdateAgentServiceInstruction<TProgramAddress, any[]>> {
  // Program address.
  ...
  } as UpdateAgentServiceInstruction<TProgramAddress, any[]>;
...
>(
  ...
  >,
  config?: { programAddress?: TProgramAddress }
): UpdateAgentServiceInstruction<TProgramAddress, any[]> {
  // Program address.
  const programAddress =
    config?.programAddress ?? GHOSTSPEAK_MARKETPLACE_PROGRAM_ADDRESS;
