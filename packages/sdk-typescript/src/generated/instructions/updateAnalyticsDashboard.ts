...
>(
...
): Promise<UpdateAnalyticsDashboardInstruction<TProgramAddress, any[]>> {
  // Program address.
  ...
  } as UpdateAnalyticsDashboardInstruction<TProgramAddress, any[]>;
...
>(
  ...
  >,
  config?: { programAddress?: TProgramAddress }
): UpdateAnalyticsDashboardInstruction<TProgramAddress, any[]> {
  // Program address.
  const programAddress =
    config?.programAddress ?? GHOSTSPEAK_MARKETPLACE_PROGRAM_ADDRESS;
