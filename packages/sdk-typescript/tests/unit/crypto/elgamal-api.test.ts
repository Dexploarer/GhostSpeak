...
describe('ElGamal API Structure', () => {
  describe('Module Exports', () => {
    it('should export all required functions and types', async () => {
      const elgamalModule = await import('../../src/utils/elgamal')
  ...
  describe('Key Generation API', () => {
    it('should generate keypair with correct structure', async () => {
      const { generateElGamalKeypair } = await import('../../src/utils/elgamal')
    ...
    it('should derive keypair from signer', async () => {
      const { deriveElGamalKeypair } = await import('../../src/utils/elgamal')
  ...
  describe('Encryption API', () => {
    it('should create ciphertext with correct structure', async () => {
      const { generateElGamalKeypair, encryptAmount } = await import('../../src/utils/elgamal')
    ...
    it('should return randomness with encryption result', async () => {
      const { generateElGamalKeypair, encryptAmountWithRandomness } = await import('../../src/utils/elgamal')
    ...
    it('should validate input ranges', async () => {
      const { generateElGamalKeypair, encryptAmount, MAX_DECRYPTABLE_VALUE } = await import('../../src/utils/elgamal')
  ...
  describe('Proof Generation API', () => {
    it('should generate range proof with correct structure', async () => {
      const { 
        ...
        generateRangeProof 
      } = await import('../../src/utils/elgamal')
  ...
  describe('Utility Functions API', () => {
    ...
    it('should validate ciphertext structure', async () => {
      const { generateElGamalKeypair, encryptAmount, isValidCiphertext } = await import('../../src/utils/elgamal')
  ...
  describe('Error Handling', () => {
    it('should handle serialization errors', async () => {
      const { deserializeCiphertext } = await import('../../src/utils/elgamal')
    ...
    it('should handle range proof validation', async () => {
      const { generateRangeProof } = await import('../../src/utils/elgamal')
  ...
  describe('Constants', () => {
    it('should export correct maximum decryptable value', async () => {
      const { MAX_DECRYPTABLE_VALUE } = await import('../../src/utils/elgamal')
