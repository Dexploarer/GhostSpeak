...
describe('Token 2022 Utilities', () => {
  // Test addresses (proper base58 format)
  const testOwner = address('11111111111111111111111111111112')
  const testMint = address('So11111111111111111111111111111111111111112')
  const testMint2022 = address('TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb')
