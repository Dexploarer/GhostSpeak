...
const MOCK_FACILITATORS: FacilitatorResponse[] = [
  {
    id: 'ghostspeak',
    name: 'GhostSpeak',
    description: 'GhostSpeak native Solana x402 facilitator with escrow, reputation, and work order support',
    logo: 'https://www.ghostspeak.io/favicon.ico',
    website: 'https://www.ghostspeak.io',
    networks: ['solana', 'solana-devnet'],
    discoveryUrl: 'https://www.ghostspeak.io/api/x402/resources',
    settleUrl: 'https://www.ghostspeak.io/api/x402/settle',
    verifyUrl: 'https://www.ghostspeak.io/api/x402/verify',
    enabled: true,
