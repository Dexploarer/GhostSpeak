...
const MOCK_TOOLS: OpenAITool[] = [
  {
    ...
    function: {
      ...
      description: 'Generate high-quality text using advanced AI models with x402 micropayments. Cost: 0.001 USDC per request on Solana.',
      parameters: {
        type: 'object',
        properties: {
          prompt: {
  ...
  },
  {
    ...
    function: {
      ...
      description: 'AI-powered code completion and generation. Cost: 0.005 USDC per request on Base.',
      parameters: {
        type: 'object',
        properties: {
          code: {
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Summarize long documents and articles using AI. Cost: 0.002 USDC per request on Solana.',
      parameters: {
        type: 'object',
        properties: {
          text: {
