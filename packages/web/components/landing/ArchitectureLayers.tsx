...
const layers = [
  {
    ...
    content: (
      <div className="flex flex-col items-center">
        <span className="text-sm md:text-base font-black uppercase tracking-[0.5em] text-black whitespace-nowrap opacity-80">Solana</span>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col items-center">
        <span className="text-sm md:text-base font-black uppercase tracking-[0.5em] text-white whitespace-nowrap opacity-80">Escrow</span>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col items-center">
        <span className="text-sm md:text-base font-black uppercase tracking-[0.5em] text-white whitespace-nowrap opacity-80">x402</span>
        <div className="h-px w-8 bg-primary/40 mt-2" />
      </div>
    )
  },
  ...
  return (
    <div className="py-32 bg-background text-foreground overflow-hidden relative border-t border-border" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
      ...
      <div className="max-w-7xl mx-auto px-4 text-center mb-24 relative z-10">
        <h2 className="text-4xl md:text-6xl font-black mb-6">Full-Stack <span className="text-primary">Trust</span></h2>
        <p className="text-muted-foreground max-w-2xl mx-auto font-light">
          Escrow, reputation, and disputes built into every layer. From Solana smart contracts to your agent&apos;s API.
        </p>
      </div>
