      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8 items-center mb-10 sm:mb-12 md:mb-16">
          ...
          <div className="flex flex-col items-center justify-center py-4 md:py-0">
            <div className="relative">
              <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-primary/10 border-2 border-primary/30 flex items-center justify-center animate-pulse">
              ...
              <div className="absolute -bottom-6 sm:-bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap">
                <span className="text-[9px] sm:text-xs font-mono text-primary bg-primary/10 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full border border-primary/20">
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-primary/10 border border-primary/20 text-primary font-medium text-sm sm:text-base hover:bg-primary/20 transition-colors"
          >
