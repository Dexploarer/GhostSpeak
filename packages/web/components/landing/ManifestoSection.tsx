...
export function ManifestoSection() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-screen flex items-center justify-center bg-primary text-primary-foreground overflow-hidden py-16 sm:py-24 md:py-32"
    >
      {/* Background Texture */}
      ...
      <div className="max-w-[95vw] sm:max-w-[90vw] mx-auto relative z-10 grid gap-8 sm:gap-12 md:gap-24">
        {/* Statement 1 */}
        <motion.div
        ...
        >
          <div className="text-[10px] sm:text-[12px] md:text-sm font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] mb-2 border-b-2 border-primary-foreground/20 inline-block pb-1">
            What Makes Us Different
          </div>
          <h2 className="text-4xl sm:text-6xl md:text-8xl lg:text-[10rem] font-black tracking-tighter leading-[0.85] uppercase">
            Trust <br />
