...
const GhostMascot3D = dynamic(() => import('./3d/GhostMascot3D').then((mod) => mod.GhostMascot3D), {
  ssr: false,
})
        ...
        <div className="relative flex justify-center lg:justify-end">
          ...
          >
            ...
            <div className="absolute top-0 left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <StatusLabel label="Kernel_Version" value="v1.0.4" variant="dim" />
            </div>
            ...
            <div className="absolute bottom-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <StatusLabel label="Settlement" value="INSTANT" variant="primary" align="right" />
            </div>
            ...
            >
              <StatusLabel label="Network_Consensus" value="VERIFIED" variant="primary" animate />
