        ...
        >
          ...
          {Array.from({ length: 12 }).map((_, i) => {
            ...
            return (
              ...
              >
                {/* Top tooth */}
                <rect x={55 + i * 10} y={-3} width={8} height={6} fill="#000000" rx={1} />
                {/* Bottom tooth */}
                <rect x={55 + i * 10} y={3} width={8} height={6} fill="#000000" rx={1} />
              </motion.g>
            )
          ...
          >
            <circle cx="0" cy="0" r="6" fill="#000000" stroke="#000000" strokeWidth="1.5" />
            <rect x="-1" y="-12" width="2" height="12" fill="#000000" />
            <ellipse cx="0" cy="-15" rx="4" ry="3" fill="#000000" />
          </motion.g>
        </motion.g>
      </svg>
    </motion.div>
