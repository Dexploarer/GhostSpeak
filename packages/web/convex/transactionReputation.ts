/**
 * Transaction Reputation Update System
 *
 * Shared reputation calculation logic for both:
 * - Payment webhook events (fast path)
...
/**
 * Calculate reputation change from a payment transaction
 *
...
/**
 * Update agent reputation from a payment transaction event
 *
 * Called by:
  ...
  handler: async (ctx, args) => {
    ...
    if (args.success) {
      ...
      if (consistencyBonus > 0) {
        console.log('[Transaction Reputation] Consistency bonus:', {
    ...
    if (existing) {
      ...
      console.log('[Transaction Reputation] Updated reputation:', {
        agent: args.merchantAddress.slice(0, 8),
        previousScore,
        newScore,
      ...
      console.log('[Transaction Reputation] Created new reputation:', {
        agent: args.merchantAddress.slice(0, 8),
