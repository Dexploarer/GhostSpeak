 ...
 */
function deserializeString(bytes: Uint8Array, offset: number): { value: string; newOffset: number } {
 ...
 */
function deserializeVecString(bytes: Uint8Array, offset: number): { value: string[]; newOffset: number } {
