...
impl DynamicPricing {
    ...
    pub fn update_demand(&mut self, demand: u64, timestamp: i64) {
        ...
        self.demand_metrics.average_demand = (self.demand_metrics.average_demand * 9 + demand) / 10;
    }
    ...
    pub fn update_supply(&mut self, supply: u64, timestamp: i64) {
        ...
        self.supply_metrics.average_supply = (self.supply_metrics.average_supply * 9 + supply) / 10;
    }

    pub fn should_update_price(&self, current_time: i64) -> bool {
        self.is_active && (current_time - self.pricing_data.last_updated) >= 3600
        // Default to 1 hour
    }
}
...
impl DynamicPricingEngine {
    ...
    pub fn calculate_dynamic_price(&self, demand: u64, supply: u64) -> u64 {
        ...
        let price_adjustment = match self.algorithm {
            ...
            PricingAlgorithm::MarketBased => demand_ratio,
    ...
    pub fn should_update(&self, current_time: i64) -> bool {
        self.is_active && (current_time - self.last_updated) >= self.config.update_frequency
    }
}
