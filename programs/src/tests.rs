...
pub mod tests {
    ...
    fn test_pda_derivation() {
        ...
        let (derived_pda_2, bump_2) = Pubkey::find_program_address(
            &[b"agent", agent_id.as_ref()],
            &program_id,
        );
    ...
    fn test_fee_calculation() {
        ...
        println!("Platform fee: {} lamports for {} lamports", platform_fee, amount);
    }
